...
namespace Codx.Auth.Data.Migrations.Users
{
    ...
    [Migration("20260513144903_AddWorkspaceUserAddFields")]
    partial class AddWorkspaceUserAddFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Codx.Auth.Data.Entities.Enterprise.Company", b =>
                {
                    ...
                    b.HasIndex("Status", "TenantId")
                        .HasDatabaseName("IX_Companies_Status_Tenant");

                    b.ToTable("Companies");
                });

            modelBuilder.Entity("Codx.Auth.Data.Entities.Enterprise.EmailTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Codx.Auth.Data.Entities.Enterprise.Invitation", b =>
                {
                    ...
                    b.Property<string>("ApplicationRoles")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Codx.Auth.Data.Entities.Enterprise.UserApplicationRole", b =>
                {
                    ...
                    b.HasIndex("UserId", "TenantId", "CompanyId", "Status")
                        .HasDatabaseName("IX_UserApplicationRoles_Status_User");
            ...
            modelBuilder.Entity("Codx.Auth.Data.Entities.Enterprise.UserMembership", b =>
                {
                    ...
                    b.HasIndex("UserId", "Status", "TenantId")
                        .HasDatabaseName("IX_UserMemberships_Status_User");
